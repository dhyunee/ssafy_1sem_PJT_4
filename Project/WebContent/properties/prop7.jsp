...
<html lang="kor">
  ...
  <body>
      ...
      <div class="container">
        <div class="row justify-content-center align-items-center">
          <div class="col-lg-9 text-center mt-5">
            <h1 class="heading" data-aos="fade-up">익선동 운현신화타워</h1>
      ...
      <div class="container" id="map">
        <div class="row justify-content-between">
          <div class="col-lg-7">
            ...
            <div class="blank"></div>
            <h5 class="heading text-primary"><strong>익선동 운현신화타워</strong></h5>
            <p class="meta">서울특별시 종로구 종로1가</p>
    ...
    <script>
      ...
      var mapOption = { 
          center: new kakao.maps.LatLng(37.5752, 126.989), // 지도의 중심좌표
          level: 3 // 지도의 확대 레벨
      };
      ...
      // 마커가 표시될 위치입니다 
      var markerPosition  = new kakao.maps.LatLng(37.5752, 126.9891); 
