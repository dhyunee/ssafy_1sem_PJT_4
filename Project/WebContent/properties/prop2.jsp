...
<html lang="kor">
  ...
  <body>
      ...
      <div class="container" id="map">
        <div class="row justify-content-between">
          <div class="col-lg-7">
            ...
            <div class="blank"></div>
            <h5 class="heading text-primary"><strong>행촌동 대성맨션</strong></h5>
    ...
    <script>
      ...
      var mapOption = { 
          center: new kakao.maps.LatLng(37.5727, 126.9625), // 지도의 중심좌표
          level: 3 // 지도의 확대 레벨
      };
      ...
      // 마커가 표시될 위치입니다 
      var markerPosition  = new kakao.maps.LatLng(37.5727, 126.9625); 
