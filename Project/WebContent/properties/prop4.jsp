...
<html lang="kor">
  ...
  <body>
      ...
      <div class="container">
        <div class="row justify-content-center align-items-center">
          <div class="col-lg-9 text-center mt-5">
            <h1 class="heading" data-aos="fade-up">효제동 포레스트힐시티</h1>

            <nav aria-label="breadcrumb" data-aos="fade-up" data-aos-delay="200">
              <ol class="breadcrumb text-center justify-content-center">
                <li class="breadcrumb-item active text-white-50" aria-current="page">
                  서울특별시 종로구 효제동 대학로 33
                </li>
              </ol>
            </nav>
          </div>
      ...
      <div class="container" id="map">
        <div class="row justify-content-between">
          <div class="col-lg-7">
            ...
            <div class="blank"></div>
            <h5 class="heading text-primary"><strong>효제동 포레스트힐시티</strong></h5>
            <p class="meta">서울특별시 종로구 효제동 대학로 33</p>
    ...
    <script>
      ...
      var mapOption = { 
          center: new kakao.maps.LatLng(37.574, 127.0018), // 지도의 중심좌표
          level: 3 // 지도의 확대 레벨
      };
      ...
      // 마커가 표시될 위치입니다 
      var markerPosition  = new kakao.maps.LatLng(37.574, 127.0018); 
